...
{
    /// <summary>
    /// Copied from Microsoft.Owin.Security.Cookies.CookieAuthenticationHandler in Katana Project in CodePlex
    /// </summary>
    public class OapCookieAuthenticationHandler : AuthenticationHandler<CookieAuthenticationOptions>
    {
        ...
        public OapCookieAuthenticationHandler(ILogger logger)
        {
        ...
        /// <summary>
        /// Applies challenge to the response
        /// </summary>
        /// <returns></returns>
