namespace Ensco.Irma.Data.Migrations
{
    ...
    public partial class AddRigOapChecklistQuestionNoAnswerCommentAndFindingModifications : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Oap_RigOapChecklistQuestionFindings", "FileName", c => c.String());
            DropColumn("dbo.Oap_RigOapChecklistQuestionFindings", "File");
        }
        
        public override void Down()
        {
            AddColumn("dbo.Oap_RigOapChecklistQuestionFindings", "File", c => c.String());
            ...
            DropColumn("dbo.Oap_RigOapChecklistQuestionFindings", "FileName");
